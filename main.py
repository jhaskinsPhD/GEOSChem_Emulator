...
rate_files='/uufs/chpc.utah.edu/common/home/u6044586/python_scripts/modules/GEOSChem_Emulator/Input_Files/fullchem.eqn'
...
gcem.make_GC_mechanism(kppfile, rate_files, GC_version, jmap_type, include_het_rxns, output_dir, overwrite=overwrite)
